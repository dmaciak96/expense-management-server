...
class UserManagementControllerTest {
    ...
    @Test
    fun `when sending registration request then register new user via registration service`() {
        // given
        whenever(userManagementService.registerNewUser(eq(USER_REGISTRATION_DOMAIN_MODEL)))
    ...
    @Test
    fun `when asking for user details then get user from service and map to response`() {
        // given
        whenever(userManagementService.getUserById(eq(USER_ID)))
            .thenReturn(USER_DOMAIN_MODEL)
        ...
        // then
        verify(userManagementService).getUserById(eq(USER_ID))
    ...
    @Test
    fun `when updating user account then call service and map response`() {
        // given
        whenever(
